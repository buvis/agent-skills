...
GOLDEN_TRANSCRIPT = (
    ...
    / ".claude"
    / "projects"
    / "-Users-you-git-src-github-com-buvis-engram"
    ...
    lines = [
        _assistant_turn(
            _tool_use(
                "Write",
                {
                    "file_path": "/Users/you/.claude/dev/local/tmp/task-prompt-3.txt",
                    "content": "x",
                },
            ),
            _tool_use(
                "Write",
                {
                    "file_path": "/Users/you/.claude/dev/local/tmp/dispatch-tess-7.txt",
                    "content": "y",
                },
            ),
        ),
...
@pytest.mark.parametrize(
    "file_path",
    [
        "/Users/you/.claude/dev/local/tmp/notes.txt",  # no "prompt", no "dispatch-" prefix
        "/Users/you/.claude/dev/local/other/prompt-file.txt",  # "prompt" but wrong dir
        "/Users/you/.claude/work/scripts/check_build_overhead.py",  # unrelated path
    ],
)
    ...
    lines = [
        ...
        _assistant_turn(
            _tool_use(
                "Write",
                {
                    "file_path": "/Users/you/.claude/dev/local/tmp/dispatch-x.txt",
                    "content": "y",
                },
            ),
        ),
    ...
    lines = [
        ...
        _assistant_turn(
            _tool_use(
                "Write",
                {
                    "file_path": "/Users/you/.claude/dev/local/tmp/task-prompt-9.txt",
                    "content": "x",
                },
            ),
        ),
        _assistant_turn(
            _tool_use(
                "Write",
                {
                    "file_path": "/Users/you/.claude/dev/local/tmp/dispatch-tess-99.txt",
                    "content": "y",
                },
            ),
        ),
