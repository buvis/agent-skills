...
1. **Pattern scan** - find similar existing implementations. For skills: scan `~/.agents/skills/` for structure conventions. For hooks: scan `~/.claude/hooks/`. For the relevant project: scan source directories.
