...
```bash
python3 ~/.agents/skills/create-skill/scripts/init_skill.py <skill-name> --path <output-directory> [--resources scripts,references,assets]
```

Examples:

```bash
python3 ~/.agents/skills/create-skill/scripts/init_skill.py my-skill --path ~/.agents/skills
python3 ~/.agents/skills/create-skill/scripts/init_skill.py my-skill --path .claude/skills --resources scripts,references
```
...
```bash
python3 ~/.agents/skills/create-skill/scripts/validate_skill.py <path/to/skill-folder>
```
