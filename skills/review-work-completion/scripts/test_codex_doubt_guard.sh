...
SKILL_MD="/Users/you/.claude/skills/review-work-completion/SKILL.md"
CHECK_SCRIPT="/Users/you/.claude/skills/review-work-completion/scripts/check_review_file.py"
