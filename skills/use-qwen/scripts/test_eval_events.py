"""Tests for eval_harness/events.py: reading transcripts."""
import json
...
from eval_harness_engine_helpers import (ASCII_TEXT, BASE, FINAL_TEXT, STAMP, _assistant,
                                         _expected_usage, _stamp, _user)
