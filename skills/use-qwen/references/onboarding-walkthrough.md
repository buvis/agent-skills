...
```
~/.agents/skills/use-qwen/scripts/qwen-run.sh --register-model -P llamacpp8001 --name "Qwen3.6 27B MTP (Llama, :8001)"
```
...
```
~/.agents/skills/use-qwen/scripts/run-eval.sh \
...
```
~/.agents/skills/use-qwen/scripts/promote-default.sh unsloth/Qwen3.6-27B-MTP-GGUF:UD-Q6_K_XL
```
