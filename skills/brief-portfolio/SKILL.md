...
```bash
python3 ~/.agents/skills/brief-portfolio/scripts/collect.py
```
...
```bash
python3 ~/.agents/skills/brief-portfolio/scripts/build.py
...
npm --prefix ~/.agents/skills/brief-portfolio/app run build
cp ~/.agents/skills/brief-portfolio/app/dist/index.html ~/.agents/skills/brief-portfolio/assets/template.html
npm --prefix ~/.agents/skills/brief-portfolio/app test
```
