...
- If it's a date (YYYY-MM-DD), find matching files via `Glob("~/.codex/session-data/YYYY-MM-DD-*.md")`

**If no argument:**
- Find most recent: `Glob("~/.codex/session-data/*.md")`, pick the latest by modification time
