...
description: Use when performing a Codex health check or reviewing setup quality. Triggers on "audit Codex config", "full audit", "health check", "audit everything", "check my setup".
