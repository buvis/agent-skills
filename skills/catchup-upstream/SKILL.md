...
compatibility: "Portable standalone compatibility copy of the git-ferry plugin skill for agents without that plugin; Claude Code uses the namespaced plugin skill."
---
...
```bash
git remote show <remote> | rg -n 'HEAD branch'
```
