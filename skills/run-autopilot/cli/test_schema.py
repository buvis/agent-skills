...
LIVE_STATE_JSON = Path("/Users/you/.claude/dev/local/autopilot/state.json")
GOLDEN_DIR = Path("/Users/you/.claude/skills/run-autopilot/scripts/golden")
CLI_GOLDEN_DIR = Path("/Users/you/.claude/skills/run-autopilot/cli/golden")
...
WIDENED_SCALAR_ACCEPT_CASES = (
    ...
    (
        ...
        lambda s: s.__setitem__(
            "repo_root",
            "/Users/you/git/src/github.com/buvis/run-autopilot",
        ),
    ),
    (
        "design_doc",
