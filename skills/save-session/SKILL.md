...
Write to `~/.codex/session-data/YYYY-MM-DD-<project-name>-session.md` using the Write tool.
...
- **Global**: `~/.codex/decisions.md` - cross-cutting decisions about tooling, workflow, or conventions that span repos
...
- Corrections repeated across 2+ sessions (grep other session files in `~/.codex/session-data/`)
