...
- [ ] BR-3 (trash-scratch) age=12d - `scratch_bench.py`, unreferenced - cmd: `python3 ~/.agents/skills/brush/scripts/trash_untracked.py --repo <root> --rule brush-scratch scratch_bench.py`
