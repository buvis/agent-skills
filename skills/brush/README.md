...
```
            /brush [quick|dry]
                  |
   preflight guards (non-repo, home work-tree,
...
counts, and the exact resume command. If you are away and the optional
notifier is installed, it pings you when decisions are pending.
